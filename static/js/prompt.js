...
class Dialog {
  ...
  /* confirm */
  const instructions = `How to Use FloraVision:

  1. Upload: If you're on a PC, click "Upload Image" at the top left, and choose a flower image from your computer.
  
  2. Classify: Wait for the classification result to appear. You'll see the flower's name and probability.
  
  3. View: The uploaded image will be displayed. Examine it and the classification result.
  
  4. Close: To close the displayed image, click the 'X' icon at the top right of the image.
  
  Enjoy exploring FloraVision with your flower images!`
 
  document.getElementById('btnConfirm').addEventListener('click', () => {
    dialog.confirm(instructions).then((res) => {  console.log(res) })
  });